...
#define PRODUCT_NAME           "stodo" // 产品名称
...
#define INTERNAL_NAME          "stodo.exe"
#define FILE_DESCRIPTION       "It's a dead simple todo app"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "stodo.exe"    // 原始文件名
